...
public abstract class Wav {
    ...
    private static final char SHIFT_AMPLITUDE = 0x7F;
    ...
    private static final char[] ZERO_BIT = {SHIFT_AMPLITUDE, LOW_AMPLITUDE, LOW_AMPLITUDE, LOW_AMPLITUDE, LOW_AMPLITUDE, SHIFT_AMPLITUDE, HIGH_AMPLITUDE, HIGH_AMPLITUDE, HIGH_AMPLITUDE, HIGH_AMPLITUDE};
    private static final char[] SET_BIT = {SHIFT_AMPLITUDE, LOW_AMPLITUDE, SHIFT_AMPLITUDE, HIGH_AMPLITUDE, HIGH_AMPLITUDE, SHIFT_AMPLITUDE, LOW_AMPLITUDE, SHIFT_AMPLITUDE, HIGH_AMPLITUDE, HIGH_AMPLITUDE};

    private static final char[] ZERO_BIT_I = {SHIFT_AMPLITUDE, HIGH_AMPLITUDE, HIGH_AMPLITUDE, HIGH_AMPLITUDE, HIGH_AMPLITUDE, SHIFT_AMPLITUDE, LOW_AMPLITUDE, LOW_AMPLITUDE, LOW_AMPLITUDE, LOW_AMPLITUDE};
    private static final char[] SET_BIT_I = {SHIFT_AMPLITUDE, HIGH_AMPLITUDE, SHIFT_AMPLITUDE, LOW_AMPLITUDE, LOW_AMPLITUDE, SHIFT_AMPLITUDE, HIGH_AMPLITUDE, SHIFT_AMPLITUDE, LOW_AMPLITUDE, LOW_AMPLITUDE};
